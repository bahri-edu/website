          ...
          <div className="col-lg-8">
            <div className="how-to-apply">
              ...
              <p>
                ...
                المستمر ، وتحديث وتطوير المعرفة من خلال رؤية واسعة ورسالة وأهداف
                وغايات. تطمح الجامعة إلى أن تصبح أكثر تميزًا عن الجامعات التي
                سبقتها في السودان من خلال إنشاء أنظمة أكاديمية وإدارية صارمة
                وتوجيهها نحو التدريب الفني في المجالات ذات الصلة. هذا يمكن أن
                يحافظ على التزامن مع عالم سريع التغير في غضون ذلك تسعى إلى تبني
                مزايا أسلافها وتجاوز مآزقهم.
              </p>
              ...
              <div className="single-academics-card tow">
                ...
                <p className="mb-0">
                  ...
                  المعرفة والتعليم المستمر - الجودة والإنجاز - التنوع والشمولية
                  - الحرية والمسؤولية - المشاركة والدعم - وعي بيئي.
                </p>
              </div>
              ...
              <div className="single-academics-card tow">
                ...
                <p className="mb-0">
                  ...
                  طويلة الأجل بجودة مهنية عالية - تقديم حوافز للطلاب وتمكينهم من
                  الاستفادة الكاملة من المعرفة والمهارات في حياتهم الشخصية
                  والمهنية.
                </p>
              </div>
            </div>
            ...
            <div className="additional-information">
              ...
              <div className="list">
                <ul>
                  ...
                  <li>
                    <a href="#">الخلفية التاريخية</a>
                  </li>
                  <li>
                    <a href="#">حقائق و أرقام</a>
                  </li>
                  <li>
                    <a href="#">شعار الجامعة</a>
                  </li>
                  <li>
                    <a href="#">مجلس الجامعة</a>
                  </li>
                  <li>
                    <a href="#">مجلس العمداء</a>
                  </li>
                  <li>
                    <a href="#">مجلس الأساتذة</a>
                  </li>
                </ul>
              </div>
            </div>
